            ...
            ?>
                <div class="bg-gray-50 rounded-3xl p-8 md:p-12 mb-24">
                    ...
                    <div class="grid md:grid-cols-2 gap-8">
                        ...
                        <!-- Career Section or Section Image -->
                        <?php if ($career && !empty($career['title'])): 
                            // Display Career Section if it exists
                        ...
                        <?php else: 
                            // Display Section Image if career doesn't exist but section_image does
                            $section_image = $team['section_image'] ?? null;
                            if ($section_image): 
                        ?>
                            <div class="bg-white rounded-xl p-8 shadow-sm flex items-center justify-center">
                                <div class="rounded-lg overflow-hidden max-w-md mx-auto">
                                    <?php echo wp_get_attachment_image($section_image['ID'], 'large', false, array('class' => 'w-full h-auto')); ?>
                                </div>
                            </div>
                        <?php endif; ?>
                        <?php endif; ?>
