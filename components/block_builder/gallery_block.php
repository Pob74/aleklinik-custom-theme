                        ...
                        <a href="<?php echo esc_url($full_image_url); ?>"
                            ...
                            <div class="relative rounded-lg overflow-hidden group">
                                ...
                                echo wp_get_attachment_image(
                                    ...
                                    [
                                        'alt'   => $final_image_alt,
                                        'class' => 'w-full h-auto object-cover aspect-square transition-transform duration-300 group-hover:scale-105'
                                    ]
                                );
                                ?>
                            ...
                            <?php if ($index === $max_visible - 1 && $total_images > $max_visible): ?>
                                <span class="absolute inset-0 flex items-end justify-start p-4 bg-black bg-opacity-20 rounded-lg text-white text-2xl font-bold pointer-events-none">
