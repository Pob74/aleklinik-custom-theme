            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden border border-gray-100 p-5">
              ...
              <div class="space-y-3 text-gray-700">
                <p class="flex items-center">
                  ...
                  <?php 
                  $booking_horse = get_field('boking_horse', 'option');
                  if($booking_horse && $booking_horse['phone-number_horse']): ?>
                    <span><?php echo esc_html($booking_horse['phone-number_horse']); ?></span>
                  <?php endif; ?>
                </p>
                <p class="flex items-center">
                  <svg class="w-5 h-5 mr-2 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
